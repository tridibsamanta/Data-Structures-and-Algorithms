...
private:
    int totalVertices;
    vector<int> *adj;
    bool findBiconnectedComponentsUtil(int u, bool visited[], int discoveryTime[], int lowTime[], int parent[], stack<pair<int, int> >& s, int &time, int &bccCount);
...
bool Graph :: findBiconnectedComponentsUtil(int u, bool visited[], int discoveryTime[], int lowTime[], int parent[], stack<pair<int, int> >& s, int &time, int &bccCount) {
